			...
			<div id="branding">
				<h1 id="site-title">
							<a href="<?php echo home_url(); ?>/" title="<?php echo bloginfo( 'name' ); ?>" rel="Home">
								<img class="logo" src="http://localhost/wpsite/wp-content/themes/Catalog/Catalog/images/logo.png" alt="<?php echo bloginfo( 'name' ); ?>" />
							</a>
						</h1>
							...
							<div class="nav_bg">
								<div class="menu">
									<ul id="menu-header-horizontal-items">
										...
										<a href="<?php echo get_option('home'); ?>"><?php _e('Home','templatic');?></a>
										</li>
