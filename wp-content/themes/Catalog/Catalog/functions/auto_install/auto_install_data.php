...
$b = array(
		...
		'footer_insert' 					=> '<div class="copyright"><p class="left">Copyright &copy; 2012 <a href="http://templatic.com/demos/Catalog">Catalog</a> All rights reserved.</p><p class="right"> Designed by <a href="http://templatic.com"><img alt="" src="'.get_stylesheet_directory_uri().'/images/templatic.png" height="20"/></a></p><p class="clearfix"></p></div>',
...
$pages_array = array();
$pages_array = array('About Us',array('Page Templates', 'Advanced Search', 'Contact Us', 'Archives', 'Full Width', 'Sitemap'));
$page_info_arr = array();
...
<p>Follow the below steps to use this page tempate in your site : 
	<ul>
		<li>1. Go to the Dashboard of your site.</li>
		<li>2. Now, Go to Dashboard >> Pages >> Add New Page. </li>
		<li>3. Give a title of your choice. Now, you will see "Page Attribute" meta box in the right hand site of the page.<br>
			Looks like : <img src="'.$dummy_image_path.'add_page.png" >
		</li>
		<li>4. Now, select a Template from here.</li>
	</ul></p>';
...
$page_info_arr['Site Map'] =  'See, how easy is to use page templates. Just add a new page and select <strong>Page - Sitemap</strong> from the page templates section. Easy peasy, isn&rsquo;t it.
';
...
$home_main_slider[1] = array(
					...
					"s2" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/blg1.jpg',
					"s2link" 	=>	'http://www.templatic.com',
					"s3" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/blg2.jpg',
					"s3link" 	=>	'http://www.templatic.com',
					"s4" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/blg5.jpg',
					"s4link" 	=>	'http://www.templatic.com',
					"s5" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/dummy1.jpg',
					"s5link" 	=>	'http://www.templatic.com',
					"s6" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/dummy3.jpg',
					"s6link" 	=>	'http://www.templatic.com',
					"s7" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/blg2.jpg',
					"s7link" 	=>	'http://www.templatic.com',
					"s8" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/blg5.jpg',
					"s8link" 	=>	'http://www.templatic.com',
					"s9" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/dummy1.jpg',
					"s9link" 	=>	'http://www.templatic.com',
					"s10" 	=>	TEMPLATE_CHILD_DIRECTORY_URL.'images/dummy/dummy3.jpg',
...
//  Category Wise Product Listing Widget for mans
...
$strpost = strpos(TEMPLATE_CHILD_DIRECTORY_PATH,'wp-content');
$target = substr(TEMPLATE_CHILD_DIRECTORY_PATH,0,$strpost).$folderpath;
full_copy( TEMPLATE_CHILD_DIRECTORY_PATH."images/dummy/", $target );
